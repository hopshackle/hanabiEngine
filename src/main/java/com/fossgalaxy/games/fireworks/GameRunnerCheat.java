...
/**
 * A version of the game runner which does not hide information from the agents.
 */
public class GameRunnerCheat {
    ...
    public GameRunnerCheat(UUID gameID, int expectedPlayers, PrintStream gameOut) {
